...
public class SilentDiscoKickoffActivity extends Activity {
    final String type = "silentdisco";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        JSONObject initialState = SilentDiscoActivity.getInitialState();
...
//        List<DbIdentity> players = members.subList(0, 2);        
        Obj game = MultiFeed.newInstance(type, initialState);
